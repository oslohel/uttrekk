...
{
    public partial class FaVCrAvsattemidler
    {
        ...
        public string LinjeRefnr { get; set; }
        public string LinjeMelding { get; set; }
        public decimal? LinjeNyettertbf { get; set; }
        public string Loennsart { get; set; }
    }
}
