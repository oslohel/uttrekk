...
namespace UttrekkFamilia
{
    internal class Mappings
    {
        ...
        private readonly NameValueCollection BVVTypeBarnevernsvaktsaker = new() {
            { "6028", "HENVENDELSE_KONTROLLBESØK" },
            { "6029", "HENVENDELSE_AKUTTSAK" },
            { "6030", "HENVENDELSE_SAVNET_BARN" },
            { "6031", "HENVENDELSE_RÅD_OG_VEILEDNING" },
            { "6032", "HENVENDELSE_SAMVÆRSSAK" },
            { "6033", "HENVENDELSE_ANNET" },
            { "6657", "HENVENDELSE_UTEBLITT_FRA_INSTITUSJON" },
            { "6658", "HENVENDELSE_UTEBLITT_FRA_HJEMMET" },
            { "7137", "HENVENDELSE_INFORMASJON" },
            { "7291", "HENVENDELSE_BEKYMRINGSMELDING" },
            { "8377", "HENVENDELSE_BISTAND_SAMARBEIDSPARTNER" },
            { "9962", "HENVENDELSE_ALARMTELEFONEN" },
            { "11562", "HENVENDELSE_ANNET" }
        };

        private readonly NameValueCollection BVVHovedkategorier = new() {
            { "5855", "16_FORELDRENES_SOMATISKE_SYKDOM" },
            { "5856", "14_FORELDRENES_PSYKISKE_PROBLEM_LIDELSE" },
            { "5857", "15_FORELDRENES_RUSMISBRUK" },
            { "5858", "13_FORELDRENES_MANGLENDE_FORELDREFERDIGHETER" },
            { "5859", "12_FORELDRENES_KRIMINALITET" },
            { "5860", "17_HØY_GRAD_AV_KONFLIKT_I_HJEMMET" },
            { "5861", "23_VOLD_I_HJEMMET_BARNET_VITNE_TIL_VOLD_I_NÆRE_RELASJONER" },
            { "5862", "06_BARNET_UTSATT_FOR_VANSKJØTSEL" },
            { "5863", "03_BARNET_UTSATT_FOR_FYSISK_MISHANDLING" },
            { "5864", "04_BARNET_UTSATT_FOR_PSYKISK_MISHANDLING" },
            { "5865", "05_BARNET_UTSATT_FOR_SEKSUELLE_OVERGREP" },
            { "5866", "02_BARNET_MANGLER_OMSORGSPERSON" },
            { "5867", "01_BARNET_HAR_NEDSATT_FUNKSJONSEVNE" },
            { "5868", "09_BARNETS_PSYKISKE_PROBLEM_LIDELSE" },
            { "5869", "11_BARNETS_RUSMISBRUK" },
            { "5870", "07_BARNETS_ADFERD" },
            { "5871", "10_BARNETS_RELASJONSVANSKER" },
            { "5872", "26_ANDRE_FORHOLD_VED_FORELDRENE_FAMILIEN" },
            { "5873", "25_ANDRE_FORHOLD_VED_BARNETS_SITUASJON" },
            { "6078", "21_SAVNET_BARN" },
            { "6079", "22_UTEBLIVELSE_FRA_HJEMME_INSTITUSJON" },
            { "7190", "24_ANNET" },
            { "11280", "07_BARNETS_ADFERD" },
            { "11281", "08_BARNETS_KRIMINALITET" },
            { "11282", "20_SAMVÆRSKONFLIKT" },
            { "11283", "19_KONFLIKT_MELLOM_BARN_UNGE" },
            { "11284", "18_KATASTROFE_KRISEHJELP" }
        };

        private readonly NameValueCollection BVVMeldere = new() {
            { "5874", "01_HENVENDELSE_MELDERTYPE_BARNET_SELV" },
            { "5875", "02_HENVENDELSE_MELDERTYPE_MOR_FAR_FORESATTE" },
            { "5876", "03_HENVENDELSE_MELDERTYPE_FAMILIE_FOR_ØVRIG" },
            { "5877", "04_HENVENDELSE_MELDERTYPE_ANDRE_PRIVATPERSONER" },
            { "5878", "05_HENVENDELSE_MELDERTYPE_BARNEVERNSTJENESTE" },
            { "5879", "06_HENVENDELSE_MELDERTYPE_NAV_KOMMUNE_OG_STAT" },
            { "5880", "07_HENVENDELSE_MELDERTYPE_BARNEVERNSVAKT" },
            { "5881", "08_HENVENDELSE_MELDERTYPE_POLITI" },
            { "5882", "09_HENVENDELSE_MELDERTYPE_BARNEHAGE" },
            { "5883", "10_HENVENDELSE_MELDERTYPE_HELSESTASJON_SKOLEHELSETJENESTEN" },
            { "5884", "11_HENVENDELSE_MELDERTYPE_SKOLE" },
            { "5885", "12_HENVENDELSE_MELDERTYPE_PEDAGOGISK_PSYKOLOGISK_TJENESTE" },
            { "5886", "13_HENVENDELSE_MELDERTYPE_PSYKISK_HELSEVERN_FOR_BARN_OG_UNGE" },
            { "5887", "14_HENVENDELSE_MELDERTYPE_PSYKISK_HELSEVERN_FOR_VOKSNE" },
            { "5888", "15_HENVENDELSE_MELDERTYPE_LEGE_TANNLEGE" },
            { "5889", "16_HENVENDELSE_MELDERTYPE_FAMILIEVERNKONTOR" },
            { "5890", "17_HENVENDELSE_MELDERTYPE_TJENESTER_OG_INSTANSER_MED_ANSVAR_FOR_OPPFØLGING_PERSONERS_RUSPROBLEMER" },
            { "5891", "18_HENVENDELSE_MELDERTYPE_KRISESENTER" },
            { "5892", "19_HENVENDELSE_MELDERTYPE_ASYLMOTTAK_UDI_INNVANDRINGSMYNDIGHET" },
            { "5893", "20_HENVENDELSE_MELDERTYPE_UTEKONTAKT_FRITIDSKLUBB" },
            { "5894", "21_HENVENDELSE_MELDERTYPE_FRIVILLIGE_ORGANISASJONER_IDRETTSLAG" },
            { "5895", "22_HENVENDELSE_MELDERTYPE_ANDRE_OFFENTLIGE_INSTANSER" },
            { "5896", "31_HENVENDELSE_MELDERTYPE_ANDRE" },
            { "6080", "25_HENVENDELSE_MELDERTYPE_UTESEKSJONEN" },
            { "6511", "26_HENVENDELSE_MELDERTYPE_INSTITUSJON" },
            { "7258", "27_HENVENDELSE_MELDERTYPE_FOSTERHJEM_BEREDSKAPSHJEM" },
            { "7290", "28_HENVENDELSE_MELDERTYPE_ADVOKAT" }, 
            { "11278", "29_HENVENDELSE_MELDERTYPE_BARNEVERNSINSTITUSJON" },
            { "11279", "30_HENVENDELSE_MELDERTYPE_AMK_LEGEVAKT_SYKEHUS" },
            { "11987", "24_HENVENDELSE_MELDERTYPE_ARRESTEN" }
        };
