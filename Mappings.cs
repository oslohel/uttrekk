...
namespace UttrekkFamilia
{
    internal class Mappings
    {
        ...
        private readonly NameValueCollection BVVMeldere = new() {
            ...
            { "5896", "30_HENVENDELSE_MELDERTYPE_ANDRE" },
            { "6080", "24_HENVENDELSE_MELDERTYPE_UTESEKSJONEN" },
            { "6511", "25_HENVENDELSE_MELDERTYPE_INSTITUSJON" },
            { "7258", "26_HENVENDELSE_MELDERTYPE_FOSTERHJEM_BEREDSKAPSHJEM" },
            { "7290", "27_HENVENDELSE_MELDERTYPE_ADVOKAT" }, 
            { "11278", "28_HENVENDELSE_MELDERTYPE_BARNEVERNSINSTITUSJON" },
            { "11279", "29_HENVENDELSE_MELDERTYPE_AMK_LEGEVAKT_SYKEHUS" },
            { "11987", "23_HENVENDELSE_MELDERTYPE_ARRESTEN" }
        };
