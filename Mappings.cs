...
namespace UttrekkFamilia
{
    internal class Mappings
    {
        ...
        private readonly NameValueCollection ÅrsakFlyttingFrakoder = new() {
            ...
            { "2.3","1.2.3_ANDRE_GRUNNER_(F.EKS._UENIGHET_OM_OPPDRAGETS_OMFANG_ØKONOMI_FORSTERKNINGSTILTAK_MANGLENDE_ELLER_LITE_EFFEKTIV_VEILEDNING_MV.)_(KREVER_PRESISERING)" }
        };
